        ...
        <el-header>
          ...
          <el-row>
            <el-col :span="7" offset="17">
              <el-button type="warning" style="width: 20vw;height: 10vw;text-align: center;font-size: 10px;margin-top: 10px" @click="handleClickAddPepole" size="mini">新增人员</el-button>
            </el-col>
          </el-row>
        ...
        <el-row style="margin-bottom: 10px">
          <el-col :span="8">
            <el-popover
              ...
              <el-button  slot="reference" type="danger" size="mini" v-show="isSC" style="width: 22vw;height: 10vw;font-size: 10px;margin-left: 10px">删除选中</el-button>
            </el-popover>
          </el-col>
          <el-col :span="8">
            <el-input
              style="width: 28vw;height: 10vw;font-size: 10px;margin-left: 10px"
              fixed="right"
              placeholder="请输入姓名"
              v-model="input"
              clearable>
          ...
          <el-col :span="8">
            <el-button type="primary" @click="finds" size="mini" style="width: 20vw;height: 10vw;font-size: 10px">搜索员工</el-button>
...
<!--    header-align="center" 只表头居中 align="center"：表头和内容都居中-->
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-button @click="handleClick(scope.$index,1)" type="primary" size="mini">编辑</el-button>
        <el-popover
          placement="top"
          width="152"
          visible-arrow="true">
