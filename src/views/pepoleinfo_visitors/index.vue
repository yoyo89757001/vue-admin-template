          ...
          <el-header>
            ...
            <el-form ref="form" :model="form" label-width="80px">
              ...
              <el-form-item label="人员类型:">
                <el-radio-group @change="pepolechange" v-model="form.radio">
                ...
                <el-form-item label="过期时间:">
                  <el-form :model="form1" :disabled="pepoleTypeDisabled">
                  <el-form-item >
                    <el-col :span="11">
                      <el-date-picker type="date" placeholder="开始日期" v-model="form1.date1" style="width: 100%;"></el-date-picker>
                    </el-col>
                    <el-col class="line" :span="2" style="text-align: center">-</el-col>
                    <el-col :span="11">
                      <el-date-picker  placeholder="结束时间" v-model="form1.date2" style="width: 100%;"></el-date-picker>
                    </el-col>
                  </el-form-item>
                 </el-form>
              </el-form-item>
